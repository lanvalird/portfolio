const data = [
  ...
  },
  {
    id: "neshy",
    name: "Neshy",
    description: "Minecraft-сервер для развлечения.",
    language: null,
    url: "https://neshy.lanvalird.ru",
    topics: ["Minecraft", "Java", "Kotlin"],
  },
  {
    id: "kristy",
    ...
    language: "TypeScript",
    topics: ["Bot", "Cute"],
    url: `https://github.com/${process.env.GITHUB_PROFILE}/KristyType`,
  ...
  },
  {
    ...
    sub: true,
    description:
      "Бла-бла-бла. Я работал над Frontend-частью и дизайном приложения.",
    language: "TypeScript",
  ...
  },
  {
    ...
    name: "Mulink OS",
    description:
      "Имитация операционной системы под браузер (разработка отложена).",
    language: "TypeScript",
    url: null,
    topics: ["Web", "React"],
    images: [
