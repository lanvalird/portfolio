...
export const projects: Project[] = [
  {
    ...
    markdown:
      ...
      "## Роль в экосистеме" +
      "\n\n" +
      "FarySD является центральным проектом в экосистеме **MiraCommunity** - " +
      "дружественном пространстве для творческих людей из моего близкого круга общения. " +
      "Здесь каждый может развивать свои идеи, находить единомышленников и чувствовать " +
    ...
    images: {
      ...
      cover: "https://fary.lanvalird.ru/background.jpg",
    },
  ...
  },
  {
    ...
    markdown: "",
    description:
      "Минимальная сборка Minecraft сервера под нужды FarySD. " +
      "Разработана как часть экосистемы Mira для обеспечения " +
      "стабильной основы проектов сообщества.",
    urls: {
  ...
  },
  {
    ...
    markdown:
      "## О проекте" +
      "\n\n" +
      "Mira — это творческая экосистема, созданная для объединения и поддержки " +
      "проектов людей из вашего близкого круга общения. " +
      "Её можно описать как дружественное пространство, где каждый участник может " +
      "развивать свои идеи, находить единомышленников " +
      "и чувствовать себя частью чего-то большего." +
      "\n\n" +
      "## Структура экосистемы" +
      "\n\n" +
      "Mira представляет собой сеть взаимного вдохновения, а не жёсткую иерархию. " +
      "Включает в себя:" +
      "\n\n" +
      ...
      "## Цель" +
      "\n\n" +
      "Объединить творческих людей, дать им возможность реализоваться в своих проектах, " +
      "не оставаясь в одиночестве.",
    description:
      "Дружественная творческая экосистема для объединения проектов близкого круга общения. " +
  ...
  },
  {
    ...
    markdown:
      ...
      "Совместная работа над переводом и озвучкой позволяет участникам развивать " +
      "творческие навыки и укреплять связи внутри сообщества." +
      "\n\n" +
      "## Участники" +
      "\n\n" +
  ...
  },
  {
    ...
    markdown:
      ...
      "## Особенности" +
      "\n\n" +
      "Проект демонстрирует творческое разнообразие экосистемы Mira, где наряду " +
      "с техническими проектами развиваются и нарративные вселенные.",
