...
export function HomeHeroSection() {
  return (
    <section
      className={
        "h-screen flex flex-col sm:grid sm:grid-cols-2 items-center gap-12"
      }
    >
      ...
      <div className={"flex flex-col gap-4 justify-self-start items-center"}>
        <h1 className={`text-6xl ${cormorantGaramond.className}`}>
          Valentin&nbsp;Bird
        </h1>
        <p
          className={
            "max-w-max italic font-medium bg-primary/25 px-4 py-1 rounded-md"
          }
        >
          Web Developer
        </p>
